...
APP_VERSION = 'fieldwork-2.34-grounded-personalisation-neutral-balanced'
app = Flask(__name__)
...
def start():
    ...
    conf=dict(conditions=conditions,trials_per_block=n,skip_practice=researcher and request.form.get('skip_practice')=='1',
              adviser_protocol='raw_agent_v17',advice_preview_ms=preview_ms,advice_modality=advice_modality,rating_items='trust_only',adviser_names=assign_adviser_names(),adviser_voices=assign_adviser_voices(),
...
def prepared_advice(con,data,trial,initial):
    ...
    no_current_estimate=protocol in {'raw_agent_v11','raw_agent_v12','raw_agent_v13','raw_agent_v14','raw_agent_v15','raw_agent_v16','raw_agent_v17'}
    ...
    if protocol in {'flexible_v8','raw_agent_v9','raw_agent_v10','raw_agent_v11','raw_agent_v12','raw_agent_v13','raw_agent_v14','raw_agent_v15','raw_agent_v16','raw_agent_v17'} and data['config']['adviser_mode']=='live':
